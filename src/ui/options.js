 ...
 * Options page wiring.
 *
 * Labels are written from the user's side of the screen. "Capitalization"
 * rather than "checkCapitalization", and each one says what it will actually
 * do to their text, because a checkbox called "mechanics" tells nobody
 * anything.
 */

import { DEFAULT_SETTINGS } from '../background/storage.js';
